...
import { postSchema, type PostFormValues } from "../NewPost/schamas/postSchema";
        ...
        <CardHeader className="space-y-4 pt-8">
          ...
          <div className="space-y-2">
            ...
            <CardDescription className="text-base">
              Faça as edições necessárias para no seu artigo.
            </CardDescription>
          </div>
        </CardHeader>
          ...
          <CardFooter className="pb-8">
            ...
            >
              {form.formState.isSubmitting ? (
                ...
                <>
                  <Send className="mr-2 h-4 w-4" /> Editar Artigo
                </>
              )}
            </Button>
          </CardFooter>
